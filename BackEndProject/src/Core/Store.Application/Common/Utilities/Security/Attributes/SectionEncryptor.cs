...
public class SectionEncryptor() : JsonIntEncryptor(SecurityKeyConstant.Section) { }
public class SectionNullableEncryptor() : JsonNullableIntEncryptor(SecurityKeyConstant.Section) { }
