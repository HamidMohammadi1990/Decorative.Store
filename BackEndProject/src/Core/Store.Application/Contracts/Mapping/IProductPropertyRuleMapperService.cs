...
{
    GetProductPropertyRuleResponse Map(ProductPropertyRule model);
    ...
    PagedResult<GetAllProductPropertyRuleResponse> Map(PagedResult<ProductPropertyRule> model);
    PagedResult<SearchProductPropertyRuleResponse> MapToSearch(PagedResult<ProductPropertyRule> model);
}
