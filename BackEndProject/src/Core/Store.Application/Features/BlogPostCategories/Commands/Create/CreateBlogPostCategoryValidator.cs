...
public class CreateBlogPostCategoryValidator : AbstractValidator<CreateBlogPostCategoryRequest>
{
    public CreateBlogPostCategoryValidator(
        ...
        ILanguageRepository languageRepository)
    {
        ...
        RuleFor(x => x)
            .MustAsync(async (request, cancellationToken) =>
                !await blogPostCategoryRepository.ExistsCodeAsync(request.Code, cancellationToken: cancellationToken))
