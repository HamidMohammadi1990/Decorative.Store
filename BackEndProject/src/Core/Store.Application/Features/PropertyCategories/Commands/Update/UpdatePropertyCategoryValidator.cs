...
{
    public UpdatePropertyCategoryValidator(IPropertyCategoryRepository propertyCategoryRepository, ILanguageRepository languageRepository)
    {
        ...
        RuleFor(x => x)
            .MustAsync(async (request, cancellationToken) =>
                !await propertyCategoryRepository.ExistsCodeAsync(request.Code, request.Id, cancellationToken))
