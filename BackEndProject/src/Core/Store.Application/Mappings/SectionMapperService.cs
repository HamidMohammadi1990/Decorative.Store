...
{
    public PagedResult<GetAllSectionResponse> Map(PagedResult<Section> model)
    {
    ...
    public PagedResult<SearchSectionResponse> MapToSearch(PagedResult<Section> model)
    {
    ...
    public GetSectionResponse Map(Section model)
    {
