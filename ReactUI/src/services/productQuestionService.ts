...
import { normalizeProductQuestionPaged } from '@/services/mappers/productQuestionNormalize'
...
export const productQuestionService = {
  async search(
  ...
  ): Promise<PagedResult<ProductQuestion>> {
    ...
    return normalizeProductQuestionPaged(data)
  },
